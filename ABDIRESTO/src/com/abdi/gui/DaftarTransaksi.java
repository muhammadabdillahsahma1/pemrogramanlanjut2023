...
public class DaftarTransaksi extends JFrame {
    ...
    DaftarTransaksi() {
        ...
        tableModel = new DefaultTableModel(
                new Object[]{"No", "Nama Customer", "Waktu", "Total Harga"},
                0
        );
    ...
    // Method to add new order to the table and database
    public void addOrder(String customerName, CustomerPage.OrderItem orderItem) {
        double totalHarga = orderItem.getTotalHarga();
